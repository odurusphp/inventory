...
<head>
    ...
    <title>RL MICRO CREDIT VENTURES</title>
    <!--favicon-->
    ...
    <div id="sidebar-wrapper" data-simplebar="" data-simplebar-auto-hide="true">
        <div class="brand-logo">
            <a href="/pages/dashboard">
                <img src="<?php echo URLROOT.'/backoffice/'?>/images/logo.fw.png" class="logo-icon" alt="logo icon">
                <h5 class="logo-text">RL MICRO</h5>
            </a>
        </div>
        <ul class="sidebar-menu do-nicescrol">
            ...
            <li>
                <a href="<?php echo URLROOT.'/pages/customers' ?>" class="waves-effect">
                    <i class="icon-briefcase"></i>
                    <span>Customer Mgt</span> <i class="fa fa-angle-left pull-right"></i>
                </a>

            </li>

            <li>
                <a  href="<?php echo URLROOT.'/account' ?>"  class="waves-effect">
                    <i class="fa fa-shopping-cart"></i> <span>Accounts Management</span>
                </a>
            </li>

            <li>
                <a  href="<?php echo URLROOT.'/pages/allpayments' ?>"  class="waves-effect">
                    <i class="fa fa-shopping-cart"></i> <span>Payments</span>
                </a>
            </li>

<!--            <li>-->
<!--                <a  href="--><?php //echo URLROOT.'/loan' ?><!--"  class="waves-effect">-->
<!--                    <i style="color:red"  class="fa fa-folder-open"></i> <span>Loan Management </span>-->
<!--                </a>-->
<!--            </li>-->
            ...
            <li>
                <a href="#" class="waves-effect">
                    <i class="fa fa-folder-open"></i> <span>Reports and Stats</span>
