...
<script src="<?php echo URLROOT ?>/backoffice/js/jquery-1.10.2.js"></script>
<script src="<?php echo URLROOT ?>/backoffice/js/jquery-ui-1.10.0.custom.js"></script>
<script src='<?php echo URLROOT ?>/backoffice/js/notify.min.js'></script>
...
<script src="<?php echo URLROOT ?>/backoffice/js/default.js"></script>
